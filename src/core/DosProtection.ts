...
export default class DosProtectionManager {
  private readonly auris: AurisDosContext
   ...
   * @param auris - AurisLink runtime context.
   */
  constructor(auris: AurisDosContext) {
    this.auris = auris
    this.config = this._resolveConfig(auris.options?.dosProtection)
