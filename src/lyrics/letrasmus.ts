...
export default class LetrasMusLyrics {
  /**
   * Runtime AurisLink context.
   */
  public readonly auris: object

  /**
   * Creates a new Letras lyrics provider.
   * @param auris - Runtime AurisLink context.
   */
  public constructor(auris: object) {
    this.auris = auris
  }
  ...
  public async getLyrics(
    ...
    try {
      ...
      log('error', 'Lyrics', `Letras lyrics error: ${message}`)
      return {
        loadType: 'error',
